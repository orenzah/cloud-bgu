...
CNT_ID=$(ssh orenzah@$REMOTE_IP "docker run --rm --name 204034482_203523006 -d -p $PORT:5201/tcp -p $PORT:5201/udp orenzah/bgu-cloud-iperf:latest")
...
A=$(ssh orenzah@$REMOTE_IP "docker container stop $CNT_ID")
echo "Script Done"
